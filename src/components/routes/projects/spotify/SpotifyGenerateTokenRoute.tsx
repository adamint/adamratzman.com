...
type SpotifyGenerateTokenRouteProps = {
...
export function SpotifyGenerateTokenRoute({
                                            spotifyTokenInfo,
                                            setSpotifyTokenInfo,
                                            codeVerifier,
                                            setCodeVerifier,
                                          }: SpotifyGenerateTokenRouteProps) {
  ...
  return <ProjectPage
    ...
    <Box mb={5}>
      ...
      <Text>This API token contains the following
        scopes: <b>{token.scope ? token.scope.split(' ').join(', ') : 'none'}</b>.</Text>
